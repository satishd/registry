 ...
 *
 */
public class KafkaAvroSerDesApp2 {
    private static final Logger LOG = LoggerFactory.getLogger(KafkaAvroSerDesApp2.class);
    ...
    public KafkaAvroSerDesApp2(String producerProps, String schemaFile) {
        this.producerProps = producerProps;
        this.schemaFile = schemaFile;
    }

    public KafkaAvroSerDesApp2(String consumerProps) {
        ...
        try {
            ...
            if (commandLine.hasOption("sm")) {
                if (commandLine.hasOption("p") && commandLine.hasOption("d") && commandLine.hasOption("s")) {
                    KafkaAvroSerDesApp2 kafkaAvroSerDesApp = new KafkaAvroSerDesApp2(commandLine.getOptionValue("p"),
                ...
                if (commandLine.hasOption("c")) {
                    KafkaAvroSerDesApp2 kafkaAvroSerDesApp = new KafkaAvroSerDesApp2(commandLine.getOptionValue("c"));
